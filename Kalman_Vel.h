...
#ifndef _Kalman_Vel_h_
#define _Kalman_Vel_h_
...
public:
    ...
    float getVelocity(float newPosition, float newRate, float dt);
...
private:
    ...
    float Q_velocity; // Process noise variance for the accelerometer
